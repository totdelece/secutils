...
/* =======================================================================
   ...
   ・料金/スペック/機能は公式サイトで現行表示を一次情報として確認（2026年7月再取得）。
     - 通常月額: ベーシック1,451 / スタンダード2,640 / プレミアム5,280円〜（2026年7月改定を反映）
     - 長期契約(36ヶ月)＋キャンペーンの最安例: 659 / 1,925 / 3,850円〜（最大54%OFF）
...
const data: PrReviewData = {
  ...
  titleAccent: "徹底検証",
  lead: "GMOインターネットグループが運営する高速レンタルサーバー「ConoHa WING」。LiteSpeed や WEXAL® Page Speed Technology® による高速化と、WordPressかんたんセットアップで申し込みと同時にブログを開設できる手軽さが人気です。通常月額1,451円〜（長期契約＋キャンペーンで659円〜の例）。初期費用無料・独自ドメイン2つ永年無料といったコスト面も、公式情報をもとに整理しました。",
  ...
  heroPoints: [
    ...
    "長期契約＋キャンペーンで659円〜の例（割引率・期限は時期により変動）",
  ],
  ...
  overview: [
    ...
    { label: "月額（ベーシック）", value: "1,451円〜（長期契約＋キャンペーンで659円〜の例）" },
    { label: "初期費用", value: "0円" },
  ...
  pros: [
    ...
    { title: "長期契約＋キャンペーンで659円〜の例", note: "WINGパックの長期割引にキャンペーンが重なると、人気サーバーを低コストで始められる（割引率・期限は変動）。" },
  ],

  cons: [
    { title: "無料お試し期間がない", note: "他社の一部サーバーと異なり、契約前に無料で試せる期間は用意されていない（2026年6月時点）。WINGパックは長期前払いのため、プランは申し込み前にしっかり検討を。" },
    { title: "最安値は長期契約＋キャンペーンが前提", note: "659円〜の例は36ヶ月のWINGパック＋キャンペーン適用時の価格。短期や通常料金では月単価が上がるため、契約期間と割引率・期限は要確認。" },
    { title: "キャンペーンで料金が変動しやすい", note: "ConoHa は時期によってキャンペーン内容・割引率・期限が変わる。申し込み時点の最新の料金を公式で必ず確認したい。" },
  ],

  campaign: {
    title: "長期契約＋キャンペーンで最大53%OFF",
    body: "WINGパックは契約期間が長いほど月額が安くなり、随時開催のキャンペーンと合わせるとベーシックが659円〜（最大54%OFF・2026年7月時点の例）に。割引率・適用条件・期限は時期により変わるため、最新の内容は公式サイトでご確認ください。",
  },

  plans: [
    { name: "ベーシック", price: "1,451", per: "月〜", note: "長期契約＋キャンペーンで659円〜の例／SSD 300GB・メモリ8GB・6コア／個人ブログの定番", popular: true, badge: "オススメ" },
    { name: "スタンダード", price: "2,640", per: "月〜", note: "キャンペーンで1,925円〜の例／SSD 400GB・メモリ12GB・8コア" },
    { name: "プレミアム", price: "5,280", per: "月〜", note: "キャンペーンで3,850円〜の例／SSD 500GB・メモリ16GB・10コア" },
  ],
  midBanner: bannerMid,
  ...
  faqs: [
    ...
    { q: "今お得なキャンペーンはありますか？", a: "ConoHa WINGは時期に応じてキャンペーンを実施しており、長期契約と合わせるとベーシックが659円〜（最大54%OFF・2026年7月時点の例）になることがあります。割引率・期限は変わるため、最新は公式サイトでご確認ください。" },
    { q: "独自ドメインは無料ですか？", a: "WINGパックなら対象の独自ドメインが最大2つ「永年無料」で使えます。第1ドメインと第2ドメインで選べるTLDが異なります。" },
    { q: "料金はいくらから？", a: "ベーシックが通常月額1,451円〜です。長期契約＋キャンペーンを適用すると659円〜になる例があります。プラン・契約期間・キャンペーンで変わるため、最新の料金は公式サイトでご確認ください。" },
  ],
  ...
  finalRating: {
    ...
    summary: (
      <>
        GMO運営の高速性と、WordPressかんたんセットアップによる手軽さを両立した人気のレンタルサーバーです。通常月額1,451円〜（長期契約＋キャンペーンで659円〜の例）で、初期費用無料・独自ドメイン2つ永年無料・転送量無制限とコスト面も充実。
