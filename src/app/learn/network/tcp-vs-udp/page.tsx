...
export default function Page() {
  return (
    <ArticleLayout article={article}>
      ...
      <h2>実体験：動画通話やゲームで感じたTCPとUDPの違い</h2>
      <p>
        動画通話やオンラインゲームを実際に使っていて、「速度というより遅延が重要なんだな」と感じる場面があります。オンラインゲームでは、一瞬の通信が多少欠けることよりも、操作してから画面に反映されるまでの遅延が大きくなる方が困るので、上記の<strong>UDPが向いている</strong>という説明がかなりイメージしやすかったです。
      </p>
      <p>
        一方で、ファイルのダウンロードなどは、多少時間がかかってもデータが欠けたり順番が入れ替わったりすると困るので、TCPのように確実に届ける仕組みが向いていると理解しています。以前は「TCPは信頼性が高くて、UDPは信頼性が低い」という暗記に近い理解でしたが、実際の用途を考えるようになってからは、<strong>「何を優先する通信なのか」という視点</strong>でTCPとUDPを考えられるようになりました。
      </p>
