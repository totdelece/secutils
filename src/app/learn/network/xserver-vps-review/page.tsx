...
/* =======================================================================
   ...
   ・料金/スペックは公式(vps.xserver.ne.jp)で再確認（2026-06-24）。
     プラン表記は「2GB / 6GB(=4GB+無料2GB増設) / 12GB(=8GB+無料4GB増設)」。
     通常月額 990/1,700/3,201円、割引時 792/1,359/2,560円。
     キャンペーンは時期で変動するため固定日付は書かない（evergreen化）。
   ・無料お試し: 公式に「無料VPS」(2GB/4GBを無料試用・2〜4日ごとに更新が必要)あり
     → 「お試しなし」とは書かない。サーバー管理が自己責任な点は正直に明記。
   ======================================================================= */
...
const data: PrReviewData = {
  ...
  overview: [
    ...
    { label: "月額（2GB）", value: "990円〜（36ヶ月契約時／割引時 792円〜）" },
    { label: "初期費用", value: "0円" },
    ...
    { label: "無料お試し", value: "「無料VPS」あり（2GB・4GB／2〜4日ごとに更新が必要）" },
  ...
  cons: [
    ...
    { title: "無料で試せるが定期更新が必要", note: "2GB・4GBプランを無料で試せる「無料VPS」はあるが、コントロールパネルから2〜4日ごとに更新が必要で放置はできない。じっくり試すなら短期の有料契約も検討を。" },
    { title: "安い価格は長期契約＋キャンペーンが前提", note: "月額990円〜は36ヶ月契約時。短期や通常時は月単価が上がるため、契約期間・キャンペーンの内容と期限は公式で要確認。" },
  ],

  campaign: {
    title: "割引キャンペーンで月792円〜になることも",
    body: "XServer VPSは時期により割引キャンペーンを実施しています（直近では2GBプランが月792円〜など）。割引率・対象プラン・期限は変動するため、申し込み前に公式サイトで最新の内容をご確認ください。",
  },

  plans: [
    { name: "2GB", price: "990", per: "月〜", note: "割引時 792円〜／3vCPU・NVMe50GB・小規模サイト/個人開発向け" },
    { name: "6GB", price: "1,700", per: "月〜", note: "割引時 1,359円〜／4vCPU・NVMe150GB・中規模サイト/アクセス増向け", popular: true, badge: "おすすめ" },
    { name: "12GB", price: "3,201", per: "月〜", note: "割引時 2,560円〜／6vCPU・NVMe400GB・大規模/高負荷アプリ向け" },
  ],
  midBanner: banner300,
  ...
  faqs: [
    ...
    { q: "無料お試しはありますか？", a: "「無料VPS」という無料お試しの仕組みがあり、2GB・4GBプランを無料で試せます。ただしコントロールパネルから2〜4日ごとに契約を更新する必要があり、永久無料ではありません。じっくり使うなら1ヶ月単位の有料契約も選べます（最新の条件は公式サイトでご確認ください）。" },
