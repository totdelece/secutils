...
/* =======================================================================
   ...
   ・料金/スペックは公式(shin-server.jp)・A8の現行表示を一次情報として確認
     （2026年6月再確認）。「月額(税込)」と「キャッシュバックで実質」の2種類があり、両方を明示。
     キャッシュバックは時期により内容・期限が変動するため、固定の期限日は書かず
     公式確認に寄せている（evergreen化）。実質額は2026年6月時点の例。
   ======================================================================= */
...
const data: PrReviewData = {
  ...
  titleAccent: "徹底検証",
  lead: "「エックスサーバーの新世代版」として登場したシンレンタルサーバー。NVMe SSD による高速性と、月額1,078円〜（キャンペーンのキャッシュバックで実質539円〜）という料金のバランスを、公式スペックをもとに整理しました。10日間の無料お試しがあるので、まずはノーリスクで使用感を確かめられます。",
  ...
  overview: [
    ...
    { label: "月額（ベーシック）", value: "1,078円〜（キャッシュバックで実質539円〜）" },
    { label: "初期費用", value: "0円" },
    { label: "無料お試し", value: "10日間" },
  ...
  pros: [
    ...
    { title: "キャッシュバックで実質539円〜", note: "36ヶ月契約＋期間限定のキャッシュバックなら、個人ブログを低コストで始められる。" },
    { title: "電話・メールサポートつき", note: "全プランでサポートに対応。初めてのサーバーでも相談しながら使える。" },
  ],

  cons: [
    { title: "安い価格は長期契約＋キャッシュバックが前提", note: "月額1,078円〜は36ヶ月契約時の価格、実質539円〜はキャッシュバック適用時。短期契約や通常時は月単価が上がるため、契約期間・キャンペーン期限は要確認。" },
  ...
  campaign: {
    title: "キャッシュバックで実質最大60%OFF",
    body: "対象プランがキャッシュバックで実質割引に（ベーシック実質539円〜＝50%OFF、スタンダード実質800円〜・プレミアム実質1,601円〜＝60%OFF。2026年6月時点の例）。実施時期・割引率・期限は変動するため、適用条件と最新の料金は公式サイトでご確認ください。",
  },

  plans: [
    { name: "ベーシック", price: "1,078", per: "月〜", note: "キャッシュバックで実質539円〜／SSD 700GB・メモリ8GB・vCPU6" },
    { name: "スタンダード", price: "2,002", per: "月〜", note: "実質800円〜／SSD 1,000GB・メモリ12GB・vCPU8／有料テーマXwrite無料", popular: true, badge: "オススメ" },
    { name: "プレミアム", price: "4,004", per: "月〜", note: "実質1,601円〜／SSD 1,200GB・メモリ16GB・vCPU10／Xwrite無料" },
  ],
  midBanner: banner300,
  ...
  faqs: [
    ...
    { q: "料金はいくらから？", a: "ベーシックプランが月額1,078円〜（36ヶ月契約時）です。さらに期間限定のキャッシュバックを利用すると実質539円〜になります。プランや契約期間・キャンペーンで変わるため、最新の料金は公式サイトでご確認ください。" },
  ],
  ...
  finalRating: {
    ...
    summary: (
      <>
        NVMe SSD による速度と、独自ドメイン永年無料・月額1,078円〜（キャッシュバックで実質539円〜）というコストのバランスが取れた新世代レンタルサーバーです。
