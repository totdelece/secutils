...
/* =======================================================================
   ...
   ・料金/スペックは公式・A8の現行表示を一次情報として確認（2026年6月）。
     「月額(税込)」と「キャッシュバックで実質」の2種類があり、両方を明示。
     キャッシュバックは期間限定(〜2026/7/7)のため、断定せず公式確認に寄せている。
   ======================================================================= */
...
const data: PrReviewData = {
  ...
  campaign: {
    ...
    body: "対象プランがキャッシュバックで実質割引に（ベーシック実質539円〜＝50%OFF、スタンダード実質800円〜・プレミアム実質1,601円〜＝60%OFF）。適用条件・期限・最新の料金は公式サイトでご確認ください。",
    deadline: "2026年7月7日",
  },
