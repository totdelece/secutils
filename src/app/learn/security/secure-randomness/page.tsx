...
function randomInt(max) {
  ...
  return n % max
      ...
      <p>
        今では新しい機能を作るときに、後述の<strong>実用チェックリスト</strong>にあるような「この用途は CSPRNG が必須か」を最初に自問するようにしています。パスワード生成のような分かりやすい用途だけでなく、意外な場所（ID生成、招待コードなど）でも同じ問いを立てる癖がついたのは、modulo bias の存在を知って「見た目のランダムさは信用できない」と痛感したからです。
      </p>
