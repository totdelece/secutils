...
export default function Page() {
  return (
    <ArticleLayout article={article}>
      ...
      <p>
        <strong>弱点</strong>: 日本国内での認知度は情報処理安全確保支援士より低いです。英語での受験が必要です。
      </p>
      ...
      <p>
        CompTIA が認定する国際的なセキュリティ入門〜中級資格です。米国政府機関の採用要件にも含まれ、英語で受験しますが国際的な認知度があります。日本国内での認知は情報処理安全確保支援士より低いです。
      </p>
