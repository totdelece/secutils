...
Access-Control-Allow-Credentials: true`}</code></pre>
      ...
      <p>
        調べて Same-Origin Policy の存在を知り、原因がようやく理解できました。個人的には、CORS を「通信できない仕組み」だと思い込んでいたのですが、実際には<strong>「サーバーには届いているけれど、ブラウザがレスポンスを JavaScript に渡してくれない」</strong>というケースがあることを知ったのが、最初の大きな学びでした。
      </p>
      <p>
