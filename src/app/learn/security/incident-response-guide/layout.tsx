...
const faqs = [
  ...
  },
  {
    ...
    a: "業種によって異なります。個人情報が流出した場合は個人情報保護委員会への報告義務があり、速報は「速やかに」（目安は概ね3〜5日以内・土日祝を含む）、確報は30日以内（不正の目的による行為が疑われる場合は60日以内）です。「72時間以内」はEUのGDPRの規定で、日本の個人情報保護法の期限ではありません。重要インフラ事業者はサイバーセキュリティ基本法に基づく報告義務があります。上場企業では有価証券報告書での開示が求められる場合もあります。",
  },
];
