...
★ 個別の攻撃も、ATT&CK上では「戦術×技術の連なり」として一望できる`}</code>
      ...
      <h2>実体験：資格勉強とMITRE ATT&amp;CKがつながった話</h2>
      <p>
        MITRE ATT&amp;CK については、セキュリティ資格の勉強やセキュリティについて調べている中で触れたことがあります。最初は攻撃手法を一覧にしたデータベースくらいの認識だったのですが、Tactics と Techniques に分けて、攻撃者が「何を達成しようとしているのか」と「そのためにどういう手法を使うのか」を体系的に整理していることを知って、かなり分かりやすい仕組みだと思いました。
      </p>
      <p>
        特に、セキュリティの勉強では「フィッシング」「認証情報の窃取」「権限昇格」など個別の攻撃を覚えることが多いですが、ATT&amp;CK を知ると、それらが攻撃者の一連の行動の中でどう位置付けられるのかを考えられるようになります。secutils の記事を書くときにも、単に「この脆弱性があります」と説明するだけでなく、<strong>「実際の攻撃者がこれをどう利用する可能性があるのか」</strong>という視点を持つようになりました。資格勉強で得た知識と実際の攻撃手法を結びつけるという意味でも、MITRE ATT&amp;CK はかなり参考になるフレームワークだと感じています。
      </p>
