...
export default function Page() {
  return (
    <ArticleLayout article={article}>
      <h2>CISSPとは</h2>
      <p>
        <strong>CISSP（Certified Information Systems Security Professional）</strong>は、非営利組織 <strong>(ISC)²</strong>（International Information System Security Certification Consortium）が認定する、世界で最も権威のある情報セキュリティ資格の一つです。1994年に創設され、現在（2025年時点）で世界180以上の国に16万人以上の認定者がいます。
      </p>
      <p>
      ...
      <h2>CISSPの8つのドメイン</h2>
      <p>
        CISSP の出題範囲は <strong>CBK（Common Body of Knowledge）</strong>と呼ばれる知識体系に基づく8ドメインで構成されます。2024年改定の最新版は以下の通りです。
      </p>
      <table>
        <thead>
          <tr>
      ...
      <h2>必要な実務経験</h2>
      <p>
        CISSP の取得には <strong>8ドメインのうち2つ以上の分野で通算5年以上の有給実務経験</strong>が必要です。ただし例外があります。
      </p>
      <table>
        <thead>
          <tr>
      ...
      <p>
        実務経験がなくても CISSP 試験を受験できます。合格後は <strong>Associate of (ISC)²</strong> として認定され、<strong>6年以内に実務経験を証明</strong>できれば正式な CISSP に昇格できます。学生や未経験者にとっては「先に試験に合格しておく」という戦略が有効です。
      </p>
      ...
      <ul>
        <li>
          <strong>Official (ISC)² CISSP Study Guide（英語）</strong>: 公式テキスト。最も網羅的だが英語のみ。全体把握に使いつつ、苦手分野を深掘りする形で活用します。
        </li>
        <li>
      ...
      <p>
        また、CISSPは単純にセキュリティの技術知識だけを問う資格ではなく、セキュリティマネジメントやリスク管理、ガバナンスなど、かなり広い範囲を扱うという点も印象的でした。支援士までは「セキュリティ技術を深く勉強する」という感覚が強かったのですが、CISSPは技術だけでなく<strong>組織としてセキュリティをどう管理するか</strong>という視点が強いので、そこは違う難しさがあると感じています。今すぐ取得する予定はありませんが、今後セキュリティの仕事を続けて実務経験を積んだら、挑戦してみたい資格の一つです。
      </p>
      ...
      <ul>
        <li><strong>継続教育（CPE）</strong>: 3年間で120時間の CPE（継続教育単位）を取得する必要があります。セキュリティカンファレンス参加・ウェビナー受講・記事執筆・教育活動などが対象。</li>
        <li><strong>年会費</strong>: 毎年$125（約2万円）の年会費が必要。</li>
        <li><strong>倫理規定</strong>: (ISC)² の倫理規定（Code of Ethics）を遵守する義務があります。</li>
      </ul>
