...
<script>document.forms[0].submit()</script>`}</code></pre>
      ...
      <p>
        CSRF は、最初に「攻撃者が偽のリクエストを送りつける」という説明だけを読んだときはピンとこなかった記憶があります。腑に落ちたのは、<strong>Cookie ベースの認証</strong>と組み合わせて考えてからでした。ユーザー本人が何も操作していなくても<strong>ログイン中のブラウザが自動で Cookie を付けて送ってしまう</strong>という一点さえ理解すれば、あとの防御策は自然に頭に入ってきます。
      </p>
      <p>
