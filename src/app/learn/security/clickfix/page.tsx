...
★ 防御の鍵＝「人間が貼り付ける瞬間」と「正規ツールの異常な起動」`}</code>
      ...
      <h2>実体験：ClickFixの手口を知って警戒するようになったこと</h2>
      <p>
        ClickFix について調べたときに、かなり怖い手法だと感じました。「私はロボットではありません」といったもっともらしい画面を表示して、何か問題が起きているように見せた上で、ユーザーにコマンドやスクリプトをコピーさせ、それを自分の PC 上で実行させるという手法です。実際に自分がその手順を実行してしまった経験はありませんが、手口を知ったときに、<strong>「ユーザーに自分で操作させることでセキュリティ対策をすり抜ける」</strong>という発想がかなり印象に残りました。
      </p>
      <p>
        特に、「コピー&amp;ペーストするだけなら安全だろう」と思ってしまうのが怖いところだと思います。これを知ってからは、Web サイト上で「このコマンドをターミナルに貼り付けてください」と突然指示された場合には、かなり警戒するようになりました。
      </p>
