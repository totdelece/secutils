...
/* 生成AIの利用に関する開示（About の編集方針とトップページで共用）。
 * Google の自己評価ガイドの「How（どのように作ったか）」に対応する。 */
export const aiUsageText =
  "調査と執筆の補助に生成AIを使用しています。数値や仕様は一次情報（RFC・公式ドキュメント・官公庁の資料）で裏取りし、コード例やツールの動作は実際に動かして確かめたうえで、運営者が内容を確認して公開しています。";
