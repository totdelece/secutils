...
export const relatedToolSlugs: Record<string, string[]> = {
  ...
  "url-encoder": ["url-parser", "base64", "html-entity", "jwt-decoder"],
  "url-parser": ["url-encoder", "ip-converter", "html-entity", "cookie-parser"],
  "password-generator": ["bcrypt", "hash-generator", "uuid-generator", "totp"],
  "hash-generator": ["hash-identifier", "hmac", "sri-hash", "bcrypt"],
  "hash-identifier": ["hash-generator", "bcrypt", "hmac", "base64"],
  "sri-hash": ["hash-generator", "security-headers", "hmac", "cookie-parser"],
  hmac: ["hash-generator", "jwt-decoder", "base64", "json-formatter"],
  bcrypt: ["hash-identifier", "password-generator", "hash-generator", "hmac"],
  ...
  "ip-converter": ["cidr-calculator", "url-parser", "port-reference", "http-status"],
...
const toolArticleFallback: Record<string, string[]> = {
  ...
  "hash-identifier": ["password-hashing", "password-strength"],
  ...
  "url-parser": ["ssrf", "path-traversal", "xss"],
